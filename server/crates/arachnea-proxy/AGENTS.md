...
- Treat this crate's `README.md` and the root `TODO.md` as the migrated source of truth from the retired proxy specification.
...
- When changing public proxy behavior, update this crate README, the root `TODO.md` when planned work changes, and append to the root `CHANGELOG.md`.
