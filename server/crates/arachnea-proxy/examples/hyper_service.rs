...
use arachnea_proxy::connectors::ArachneaHyperConnector;
...
/// Runs an HTTP GET through the hyper-oriented connector wrapper.
///
/// # Errors
///
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let mut service = ArachneaHyperConnector::new(core).into_service();
