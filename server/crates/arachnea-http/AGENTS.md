...
- Treat this crate's `README.md` and the root `docs/TODO.md` as the migrated source of truth from the retired HTTP specification.
...
- When changing public HTTP behavior, update this crate README, the root `docs/TODO.md` when planned work changes, and append to the root `CHANGELOG.md`.
