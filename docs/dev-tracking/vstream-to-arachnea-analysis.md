...
> Cible : `server/services/arachnea-stream/dark-stream/*.yaml`
...
- **Statut** : ✅ Déjà disponible dans `server/services/arachnea-stream/dark-stream/anime-sama.yaml`
...
- **Priorité** : Moyenne
- **Statut Arachnea** : ✅ Implémenté dans `server/services/arachnea-stream/dark-stream/frenchanimes.yaml`
...
La collection `arachnea-stream` est listée dans
`server/services/arachnea-stream/services.json`, qui référence les fichiers
YAML par chemin relatif et active/désactive chaque source :

```json
[
  {
    "path": "dark-stream/coflix.yaml",
    "enabled": true
  }
]
```
...
|---|-------------------------|-------------------------------------------------------------|--------|
| 1 | `coflix`                | `server/services/arachnea-stream/dark-stream/coflix.yaml`                    | ✅ Implémenté |
| 2 | `animesultra`           | `server/services/arachnea-stream/dark-stream/animesultra.yaml`               | ⛔ Bloqué POST — voir Phase 3 |
| 3 | `frenchanimes`          | `server/services/arachnea-stream/dark-stream/frenchanimes.yaml`              | ✅ Implémenté |
| 4 | `filmspourenfants`      | `server/services/arachnea-stream/dark-stream/filmspourenfants.yaml`          | 🔲     |
| 5 | `otaku_attitude`        | `server/services/arachnea-stream/dark-stream/otaku-attitude.yaml`            | 🔲     |
| 6 | `skyanimes`             | `server/services/arachnea-stream/dark-stream/skyanimes.yaml`                 | 🔲     |

### Phase 2 — Sites GET, parsing HTML plus complexe

| # | Site                    | Fichier YAML cible                                          | Statut |
|---|-------------------------|-------------------------------------------------------------|--------|
| 7 | `cpasmieux`             | `server/services/arachnea-stream/dark-stream/cpasmieux.yaml`                 | 🔲     |
| 8 | `cpasmal`               | `server/services/arachnea-stream/dark-stream/cpasmal.yaml`                   | 🔲     |
| 9 | `gum_gum_streaming_com` | `server/services/arachnea-stream/dark-stream/gum-gum-streaming.yaml`         | 🔲     |
| 10 | `adkami_com`           | `server/services/arachnea-stream/dark-stream/adkami.yaml`                    | 🔲     |
| 11 | `animeultime`          | `server/services/arachnea-stream/dark-stream/animeultime.yaml`               | 🔲     |

### Phase 3 — Sites bloqués (nécessitent support POST backend)

| # | Site            | Fichier YAML cible                                    | Bloquant                                    |
|---|-----------------|-------------------------------------------------------|---------------------------------------------|
| 12 | `animesultra`  | `server/services/arachnea-stream/dark-stream/animesultra.yaml`         | Recherche POST (`index.php?do=search`)      |
| 13 | `wiflix`       | `server/services/arachnea-stream/dark-stream/wiflix.yaml`              | Recherche POST + cookies                    |
| 14 | `french_stream` | `server/services/arachnea-stream/dark-stream/french-stream.yaml`      | Recherche POST, API JSON (POST)             |
...
| `server/services/arachnea-stream/dark-stream/anime-sama.yaml`          | **Référence principale** — YAML le plus complet             |
| `server/services/arachnea-stream/dark-stream/coflix.yaml`              | Référence YAML HTML+JSON (film/série, catégories)           |
| `server/crates/arachnea-scrapyfy/src/scrapyfy/scraper_action.rs`       | Toutes les actions disponibles                              |
| `server/services/arachnea-stream/services.json`                        | Fichier de configuration de la collection                   |
| `server/services/arachnea-stream/dark-stream/*.yaml`                   | **Destination des nouveaux YAML**                           |
| `docs/specifications/arachnea-stream-fr.md`                            | Spécification du format YAML arachnea-stream                |
