...
22. [x] **Étape 21b** — Migration des YAMLs (rtbf-auvio-be, animeultime, etc.) vers `sub_queries` entry-level. `rtbf-auvio-be.yaml` migré.
...
26. [x] **Étape 20** — Passer en revue la RustDoc de tous les nouveaux items (cf. § 4). **Placée en fin de liste** pour bénéficier des items stabilisés par les étapes 21a/b/c et 22/23.
