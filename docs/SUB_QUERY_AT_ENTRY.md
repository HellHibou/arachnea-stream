...
12. [ ] **Étape 11** — Implémenter `ScraperQuery` pour `StaticScraperQuery`.
13. [ ] **Étape 12** — Créer `HtmlScraperSubQuery` et implémenter `ScraperQuery` pour `HtmlScraperQuery`.
14. [ ] **Étape 13** — Implémenter `ScraperEntrySpec` pour `JsonScraperEntry` et `HtmlScraperEntry`.
15. [ ] **Étape 14** — Ajouter `entry_sub_queries` aux entries (récursion).
