...
- Structure every `CHANGELOG.md` release section (including `Unreleased`) as release > module > Added/Changed/Fixed: group entries under one underlined module subtitle each (`### <u>build-release</u>`, `### <u>arachnea-docker</u>`, `### <u>front-admin</u>`, `### <u>front-public</u>`, `### <u><arachnea crate name></u>`, `### <u>Other</u>`), with `#### Added`, `#### Changed` and `#### Fixed` subsections inside each module group.
